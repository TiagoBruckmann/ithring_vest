...
class UserModel extends UserEntity with EquatableMixin {
  UserModel({required super.id, required super.photo, required super.name, required super.email, required super.defaultCoin, required super.currencyFormat, required super.financialBalance, required super.oldBalance});
